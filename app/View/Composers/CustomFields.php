...
class CustomFields extends Composer
{
    ...
    public function with()
    {
        return [
            ...
            'topBarText' => $this->topBarText(),   
            'topBarButtonText' => $this->topBarButtonText(),   
            'email' => $this->email(),   
            ...
            'afterTestimonialText' => $this->afterTestimonialText(),  
            'toggleYellowBox1' => $this->toggleYellowBox1(),  
            'toggleYellowBox2' => $this->toggleYellowBox2(),  
            'toggleYellowBox3' => $this->toggleYellowBox3(),  
            'toggleYellowBox4' => $this->toggleYellowBox4(),  
            'toggleBonuses' => $this->toggleBonuses(),  
            ...
            'boxContentUpsell' => $this->boxContentUpsell(), 
            'guaranteeTextUpsell' => $this->guaranteeTextUpsell(),
            'movingButtonText' => $this->movingButtonText(),
            'contentAfterButtonUpsell' => $this->contentAfterButtonUpsell(),
            ...
            'noThanksText' => $this->noThanksText(),
            ...
            'newsletterFormImage' => $this->newsletterFormImage(),
            'newsletterFormText' => $this->newsletterFormText(),
            'newsletterFormShortcode' => $this->newsletterFormShortcode(),
            'reviewLogosHp' => $this->reviewLogosHp(),
    ...
    public function productMainImage(){
        if(get_field("product_main_image")){
            return get_field("product_main_image")['url'];
        }
    }
    ...
    public function topBarButtonText(){
        return get_field("top_bar_button_text");
    }
    ...
    public function afterTestimonialText(){
        return get_field("after_testimonials");
    }
    
    public function toggleYellowBox1(){
        return get_field("display_yellow_1");
    }
    public function toggleYellowBox2(){
        return get_field("display_yellow_2");
    }

    public function toggleYellowBox3(){
        return get_field("display_yellow_3");
    }
    public function toggleYellowBox4(){
        return get_field("display_yellow_4");
    }

    public function toggleBonuses(){
        return get_field("display_bonuses");
    }
    ...
    public function boxContentUpsell(){
        return get_field("box_content");
    }
    public function guaranteeTextUpsell(){
        return get_field("guarantee_text_upsell");
    }
    
    public function movingButtonText(){
        return get_field("moving_button_text");
    }
    public function contentAfterButtonUpsell(){
        return get_field("after_button_upsell");
    }
    public function noThanksText(){
        return get_field("no_thanks_text");
    }
...
public function newsletterFormImage(){
    if(get_field("newsletter_form_image")){
        return get_field("newsletter_form_image")['url'];
    }
}
public function newsletterFormText(){
    return get_field("newsletter_form_text");
}
public function newsletterFormShortcode(){
    return get_field("newsletter_shortcode_home");
}
...
public function aboutMeSection(){
    return get_field("about_me_section");
}
}
