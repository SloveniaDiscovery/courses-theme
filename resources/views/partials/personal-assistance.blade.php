...
<div class="font-semibold md:text-xl text-lg mt-4 text-black flex justify-center md:w-11/12 mx-auto">
    ...
    <div>
        <!-- <div class="text-left font-bold text-base ml-4">@sub('personal_assistance_headline')</div>
        <div class="text-left font-normal !text-sm ml-4">@sub('personal_assistance_text')</div> -->
